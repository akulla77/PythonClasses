...
class MongoStorage(AbstractStorage):
    ...
    async def create(self, connection: dict, database: str, collection: str):
    ...
    async def put_one(self, note: Note):
        ...
        await self.__collection.find_one_and_replace({'_id': note.id}, value, upsert=True)
    ...
    @staticmethod
    def __make_note(value: dict) -> Note | None:
        if value:
